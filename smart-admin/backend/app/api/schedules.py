...
from app.models import ClassSection, Subject, Teacher, TimetableDraft, TimetableSlot
from app.schemas.all import GenerateRequest, ReshuffleRequest, LockSlotRequest
