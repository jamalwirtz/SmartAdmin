...
from app.models import Teacher, TeacherSubject, TimetableSlot, Subject, ClassSection
from app.schemas.all import TeacherCreate, TeacherUpdate, SubjectAssignRequest
